  ...
  return (
    <section className='relative w-full h-screen mx-auto'>
      ...
      <div className='w-1 sm:h-80 h-40 violet-gradient'/>
        ...
        <div>
          <h1 className={`${styles.heroHeadText}`}>Hi, I'm <span className='text-[#915eff]'>Rudis</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop many websites, user <br className='sm:block hidden' /> interfaces and web applications.
          </p>
        </div>
